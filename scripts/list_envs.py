...
All the environments are registered in the `humanoid_twerk` extension. They start
...
import humanoid_twerk.tasks  # noqa: F401


def main():
    """Print all environments registered in `humanoid_twerk` extension."""
